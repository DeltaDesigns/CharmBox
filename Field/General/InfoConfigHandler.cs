...
public class InfoConfigHandler
{
    ...
    public void WriteToFile(string path)
    {
        ...
        if(!Directory.Exists($"{path}/Materials/Source2/"))
            Directory.CreateDirectory($"{path}/Materials/Source2/");
        
        File.WriteAllLines($"{path}/Materials/Source2/_S2BuildList.txt", s2);
